...
<div class="card-custom p-4 mx-auto" style="max-width: 500px;">
    ...
    <form method="POST" action="index.php?action=ustadz/target/store&id=<?= $santri->id ?>">
        <div class="mb-3"><label>Target (misal: Juz 30)</label><input type="text" name="target_ayat" class="form-control" required></div>
        ...
        <a href="index.php?action=ustadz/target/index&id=<?= $santri->id ?>" class="btn btn-secondary w-100 mt-2">Batal</a>
    </form>
</div>
