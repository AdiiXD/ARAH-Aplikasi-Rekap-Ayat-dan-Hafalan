...
<div class="card-custom p-4 mb-4">
    <div class="d-flex justify-content-between">
        ...
        <div>
            <a href="index.php?action=ustadz/setoran/create_hafalan&id=<?= $santri->id ?>" class="btn btn-maroon btn-sm"><i class="bi bi-plus-lg"></i> Setoran Hafalan</a>
            <a href="index.php?action=ustadz/setoran/create_murajaah&id=<?= $santri->id ?>" class="btn btn-outline-maroon btn-sm"><i class="bi bi-arrow-repeat"></i> Murajaah</a>
        </div>
    </div>
    <hr>
    <div class="row">
...
<div class="card-custom p-4 mb-4">
    <div class="d-flex justify-content-between">
        ...
        <a href="index.php?action=ustadz/target/create&id=<?= $santri->id ?>" class="btn btn-sm btn-outline-maroon">Tambah Target</a>
    </div>
...
<div class="card-custom p-4 mb-4">
    ...
    <?php if ($santri->setoranMurajaah->isEmpty()): ?>
        <p class="text-muted">Belum ada murajaah.</p>
    <?php else: ?>
        <div class="table-responsive">
            <table class="table table-hover">
                <thead>
