...
<div class="card-custom p-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a href="index.php?action=ustadz/dashboard" class="btn btn-secondary btn-sm">Kembali ke Dashboard</a>
    </div>
    <?php if (isset($_SESSION['success'])): ?>
        <div class="alert alert-success"><?= $_SESSION['success']; unset($_SESSION['success']); ?></div>
    <?php endif; ?>
    <?php if ($notifikasi->isEmpty()): ?>
        <div class="alert alert-light">Belum ada notifikasi.</div>
    <?php else: ?>
        <div class="list-group">
            ...
            <div class="list-group-item <?= $notif->is_read ? '' : 'list-group-item-warning' ?>">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <a href="index.php?action=ustadz/notifikasi/markAsRead&id=<?= $notif->id ?>" class="btn btn-sm btn-outline-success">Tandai Dibaca</a>
                    <?php endif; ?>
                </div>
            </div>
            <?php endforeach; ?>
